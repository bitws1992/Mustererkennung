...
data=can_mm72_acceleration_chassis_zneg.data;% original signal
time=can_mm72_acceleration_chassis_zneg.time;% original time
Label(88,1)=0;
Target=Label;
sumlabel(:)=0;
for i=1:L
...
save can_mm72_acceleration_chassis_zneg
